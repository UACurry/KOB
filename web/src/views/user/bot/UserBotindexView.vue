...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://lwy.gowarriors.top/api/user/bot/getlist/",
                type: "get",
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://lwy.gowarriors.top/api/user/bot/add/",
                type: "post",
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://lwy.gowarriors.top/api/user/bot/update/",
                type: "post",
                // 根据后端需要的参数来
                data: {
                    bot_id: bot.id,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://lwy.gowarriors.top/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
